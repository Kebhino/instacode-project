          ...
          >
            ...
            <VStack gap={4} align="start">
              ...
              <Text fontSize="lg" color="gray.700">
                ...
                providerów internetowych — obsługę domen internetowych,
                tworzenie kont pocztowych, FTP, baz danych, hosting stron.
                Wszystko to w czasach, gdy internet dopiero raczkował.
              </Text>
              ...
              <Text fontSize="lg" color="gray.700">
                Zinformatyzowaliśmy firmę <b>ABART</b>, obejmując naszym
                systemem każdy aspekt działalności — od{" "}
                <b>automatycznych wycen</b>, po{" "}
              ...
              <Text fontSize="lg" color="gray.700">
                ...
                rozbudowane raportowanie (firmy: iCentrum S.A., APS Poland
                S.A.).
              </Text>
              ...
              <Text fontSize="lg" color="gray.700">
                ...
                kompleksowe rozwiązanie dla firmy <b>InstaGlas</b>,
                umożliwiające precyzyjne śledzenie wszystkich kosztów projektów,
                w tym kosztów pracowniczych, oraz finalne raportowanie
                rentowności.
              </Text>
