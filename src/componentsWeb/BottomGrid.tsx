...
import logoCuprum from "@/assets/logaSlider/cuprum-logo.webp";
import logoAbart from "@/assets/logaSlider/abart-logo.webp";
import logoZL from "@/assets/logaSlider/znanylekarz-logo.webp";
    ...
    >
      <Box bg="#F6FCFE" p={5} borderRadius={10}>
        <VStack gap={2} align="center">
          <Image src={logoAbart} color="#00163E" />

          <Text fontSize={10} marginTop={3} textAlign={"left"}>
      ...
      <Box bg="#F6FCFE" p={3} borderRadius={10}>
        <VStack gap={2} align="center">
          <Image src={logoZL} color="#00163E" />
